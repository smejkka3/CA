...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{import} \PY{n+nn}{scipy} \PY{k}{as} \PY{n+nn}{sp}
...
the learning rate.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{train\PYZus{}perceptron}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{,}\PY{n}{iterations}\PY{o}{=}\PY{l+m+mi}{200}\PY{p}{,}\PY{n}{eta}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{option}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{n}{X} \PY{o}{=} \PY{n}{sp}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{sp}\PY{o}{.}\PY{n}{ones}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{X}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}N data points (D+1)*N==\PYZgt{} X}
            \PY{c+c1}{\PYZsh{}initialize weight vector}
            \PY{n}{weights} \PY{o}{=} \PY{n}{sp}\PY{o}{.}\PY{n}{ones}\PY{p}{(}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{c+c1}{\PYZsh{}D+1 features==\PYZgt{} weights dimension}
            \PY{k}{for} \PY{n}{it} \PY{o+ow}{in} \PY{n}{sp}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{iterations}\PY{p}{)}\PY{p}{:}
                ...
                \PY{n}{acc}\PY{p}{[}\PY{n}{it}\PY{p}{]}\PY{o}{=}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{wrong}\PY{p}{)}\PY{o}{/}\PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                \PY{k}{if} \PY{n}{wrong}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{:}
                    ...
                    \PY{n}{ridx}\PY{o}{=}\PY{n}{sp}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{wrong}\PY{p}{)}\PY{p}{)}
                    \PY{n}{x\PYZus{}m}\PY{o}{=}\PY{n}{X}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{wrong}\PY{p}{[}\PY{n}{ridx}\PY{p}{]}\PY{p}{]}
                    \PY{n}{y\PYZus{}m}\PY{o}{=}\PY{n}{Y}\PY{p}{[}\PY{n}{wrong}\PY{p}{[}\PY{n}{ridx}\PY{p}{]}\PY{p}{]}
                    \PY{c+c1}{\PYZsh{}update weight vector (using different learning rates ) (each 1 point)}
                    \PY{k}{if} \PY{n}{option} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:}
                        \PY{n}{lrate}\PY{o}{=}\PY{n}{eta}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{it}\PY{p}{)}
                    \PY{k}{elif} \PY{n}{option} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:}
                        \PY{n}{lrate}\PY{o}{=}\PY{n}{eta}
                    \PY{k}{elif} \PY{n}{option} \PY{o}{==} \PY{l+m+mi}{2}\PY{p}{:}
                        \PY{n}{lrate}\PY{o}{=}\PY{n}{eta}\PY{o}{+}\PY{n}{eta}\PY{o}{*}\PY{n}{it}
                    \PY{c+c1}{\PYZsh{}update weight vector}
                    \PY{n}{weights}\PY{o}{=}\PY{n}{weights}\PY{o}{+}\PY{n}{lrate}\PY{o}{*}\PY{n}{x\PYZus{}m}\PY{o}{*}\PY{n}{y\PYZus{}m}
                    
            \PY{n}{b} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{n}{weights}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{c+c1}{\PYZsh{} first item of vector weights}
            \PY{n}{w} \PY{o}{=} \PY{n}{weights}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]} \PY{c+c1}{\PYZsh{}indeed weight}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{n}{w\PYZus{}per}\PY{p}{,}\PY{n}{b\PYZus{}per}\PY{p}{,}\PY{n}{acc} \PY{o}{=} \PY{n}{train\PYZus{}perceptron}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{,} \PY{n}{option}\PY{o}{=}\PY{n}{option}\PY{p}{)}
...
\tightlist
\item
  The accuracy converge asymptotically.
\item
  For the update rules,the learning rate in option 0 decrease slowly as
  interating, it converge fastly and steadily. In option 1 the learning
  rate is a constant,it converge a litte slower than option 1 and in
  option 2, the learing rate is bigger than initial learning rate and
  will growing as the growth of iterations, hence it looks much more
  volatile than others.
\item
  I prefer to choose option 0, since it can be easily seen that it gives
  a fast converge and less see-sawed than others in this case
\end{itemize}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{analyse\PYZus{}accuracies\PYZus{}perceptron}\PY{p}{(}\PY{n}{digit}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{option}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
...
will be deducted for the use of loops.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{train\PYZus{}ncc}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{                 b       \PYZhy{}  bias term for linear classification                          }
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            \PY{n}{posX}\PY{o}{=}\PY{n}{X}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{Y}\PY{o}{\PYZgt{}}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{negX}\PY{o}{=}\PY{n}{X}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{Y}\PY{o}{\PYZlt{}}\PY{l+m+mi}{0}\PY{p}{]}
        
            \PY{n}{posX\PYZus{}mean}\PY{o}{=}\PY{n}{posX}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
            \PY{n}{negX\PYZus{}mean}\PY{o}{=}\PY{n}{negX}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
            \PY{n}{w}\PY{o}{=}\PY{n}{posX\PYZus{}mean}\PY{o}{\PYZhy{}}\PY{n}{negX\PYZus{}mean}
            \PY{n}{b}\PY{o}{=}\PY{p}{(}\PY{p}{(}\PY{n}{posX\PYZus{}mean}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{posX\PYZus{}mean}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{n}{negX\PYZus{}mean}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{negX\PYZus{}mean}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{2}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{plot\PYZus{}histogram}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{Y}\PY{p}{,} \PY{n}{w}\PY{p}{,} \PY{n}{b}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{c+c1}{\PYZsh{}Title contains the accuracy                X       +1 point (label,legend,title)}
...
accuracy of the algorithm is printed as the title of the plot.}
    ...
    Perceptron would be better for this task since it performs a higher
accuracy than NCC in almost every classes.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{seq}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{]}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{seq}\PY{p}{:}
            \PY{n}{compare\PYZus{}classifiers}\PY{p}{(}\PY{n}{digit} \PY{o}{=} \PY{n}{i}\PY{p}{)}
\end{Verbatim}
